...
public class OnTransitionTextListener implements Indicator.OnTransitionListener {
	...
	public final OnTransitionTextListener setColor(int selectColor, int unSelectColor) {
		...
		gradient = new ColorGradient(
				SkinCompatResources.getColor(AppContext.getInstance(), SkinCompatHelper.checkResourceId(unSelectColor)),
				SkinCompatResources.getColor(AppContext.getInstance(), SkinCompatHelper.checkResourceId(selectColor)), 100);
		return this;
	}
